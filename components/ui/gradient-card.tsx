  ...
  return (
    <div className="flex h-auto w-full items-center justify-center">
      ...
      >
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 z-25 h-1/4 w-[1px] rounded-full"
          style={{
            background:
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 z-25 h-1/4"
          style={{
            background:
        ...
        />
        <motion.div
          className="absolute right-0 bottom-0 z-25 h-1/4 w-[1px] rounded-full"
          style={{
            background:
              "linear-gradient(to top, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.5) 20%, rgba(255, 255, 255, 0.3) 40%, rgba(255, 255, 255, 0.1) 60%, rgba(255, 255, 255, 0) 80%)",
          }}
        ...
        />
        <motion.div
          className="absolute right-0 bottom-0 z-25 h-1/3"
          style={{
            background:
              "linear-gradient(to top, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.55) 15%, rgba(255, 255, 255, 0.4) 30%, rgba(255, 255, 255, 0.25) 45%, rgba(255, 255, 255, 0.1) 70%, rgba(255, 255, 255, 0) 85%)",
          }}
        ...
        {/* Card content */}
        <motion.div
          className="relative z-40 flex h-full flex-col p-8"
          animate={{
            z: 2,
          }}
        >
